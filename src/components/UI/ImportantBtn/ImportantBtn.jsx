...
import classes from './ImportantBtn.module.css'


const ImportantBtn = ({children, important, ...props}) => {

  
    const rootClasses = [classes.importantBtn]
        ...
        <button {...props} className={rootClasses.join(' ')}>
            <svg width="20px" height="20px" viewBox="0 0 24 24" version="1.1">
                ...
                <g id="🔍-System-Icons" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <g id="ic_fluent_important_24_filled" fill="#212121" fillRule="nonzero">
                        <path
